          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.a 
                ...
                whileTap={{ scale: 0.97 }}
                className="bg-[#F7E326] text-black px-10 py-4 rounded-lg font-bold hover:shadow-lg transition-all text-center duration-300"
              >
                {t('faq_contact_btn')}
              </motion.a>
              <motion.a 
                ...
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="bg-black text-white px-10 py-4 rounded-lg font-bold hover:shadow-lg transition-all text-center duration-300"
              >
                {t('faq_partner_btn')}
              </motion.a>
            </div>
