...
export default function About() {
  ...
  return (
    ...
    >
      {/* Decorative Circles from Figma DIV-122, DIV-123 */}
            ...
            <div className="grid md:grid-cols-2 gap-4 pt-4">
              ...
              <div className="flex items-center gap-3 p-[18px] bg-white rounded-xl hover:border hover:border-[#4B4F54] transform hover:-translate-y-1 duration-300 shadow-sm">
                <div className="w-12 h-12 flex items-center justify-center bg-[#4B4F54] rounded-lg flex-shrink-0 shadow-md">
                  ...
                  >
                    <path
                      d="M8.64 0L16.5312 1.82C16.7488 1.87333 16.928 1.99333 17.0688 2.18C17.2096 2.36667 17.28 2.57333 17.28 2.8V12.78C17.28 13.7933 17.0528 14.74 16.5984 15.62C16.144 16.5 15.5136 17.22 14.7072 17.78L8.64 22L2.5728 17.78C1.7664 17.22 1.136 16.5 0.6816 15.62C0.2272 14.74 0 13.7933 0 12.78V2.8C0 2.57333 0.0704 2.36667 0.2112 2.18C0.352 1.99333 0.5312 1.87333 0.7488 1.82L8.64 0ZM8.64 2.04L1.92 3.6V12.78C1.92 13.46 2.0704 14.0933 2.3712 14.68C2.672 15.2667 3.0912 15.7467 3.6288 16.12L8.64 19.6L13.6512 16.12C14.1888 15.7467 14.608 15.2667 14.9088 14.68C15.2096 14.0933 15.36 13.46 15.36 12.78V3.6L8.64 2.04ZM12.9216 7.22L14.2656 8.64L8.16 15L4.0896 10.76L5.4528 9.34L8.16 12.18L12.9216 7.22Z"
                      fill="white"
                    />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-sm text-[#4B4F54]">
              ...
              <div className="flex items-center gap-3 p-[16px] bg-white rounded-xl hover:border hover:border-[#F7E326] transform hover:-translate-y-1 duration-300 shadow-sm">
                ...
                <div>
                  <h3 className="font-bold text-black text-base">
                    {t("retail_network") || "Retail Network"}
                  </h3>
                  <p className="text-sm text-[#4B4F54]">
              ...
              <div className="flex items-center gap-3 p-[16px] bg-white rounded-xl hover:border hover:border-[#4B4F54] transform hover:-translate-y-1 duration-300 shadow-sm">
                <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-[#4B4F54] to-[#3B3E42] rounded-lg flex-shrink-0 shadow-md">
                  ...
                  >
                    <path
                      d="M9.12 0L18.24 5.5V16.5L9.12 22L0 16.5V5.5L9.12 0ZM2.88 6.08L9.12 9.84L15.36 6.08L9.12 2.32L2.88 6.08ZM1.92 7.82V15.34L8.16 19.12V11.58L1.92 7.82ZM10.08 19.1L16.32 15.34V7.82L10.08 11.58V19.1Z"
                      fill="white"
                    />
                  </svg>
                </div>
