...
const FeatureCard = ({ icon: Icon, id, isYellow }) => {
    ...
    return (
        <div className="bg-white rounded-2xl p-8 flex flex-col items-center text-center shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_50px_-12px_rgba(0,0,0,0.15)] transition-shadow duration-300">
            {/* Icon Container */}
